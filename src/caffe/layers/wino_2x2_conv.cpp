...
namespace caffe {
    ...
    template<typename Dtype>
    void Winograd2x2ConvLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype> *> &bottom,
    ...
    template<typename Dtype>
    void Winograd2x2ConvLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype> *> &top,
    ...
    STUB_GPU(Winograd2x2ConvLayer);
#endif

    INSTANTIATE_CLASS(Winograd2x2ConvLayer);
