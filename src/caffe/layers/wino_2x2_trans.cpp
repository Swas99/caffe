...
namespace caffe {
    ...
    template<typename Dtype>
    void Winograd2x2TransLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype> *> &bottom,
    ...
    template<typename Dtype>
    void Winograd2x2TransLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype> *> &top,
    ...
    STUB_GPU(Winograd2x2TransLayer);
#endif

    INSTANTIATE_CLASS(Winograd2x2TransLayer);
