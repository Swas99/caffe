#ifndef CAFFE_BASE_WINO_2x2_HPP_
#define CAFFE_BASE_WINO_2x2_HPP_
 ...
 */
    ...
    class BaseWinograd2x2Layer : public Layer<Dtype> {
    public:
        explicit BaseWinograd2x2Layer(const LayerParameter &param)
                : Layer<Dtype>(param) {}
