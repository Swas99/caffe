#ifndef CAFFE_BASE_WINO_LAYER_HPP_
#define CAFFE_BASE_WINO_LAYER_HPP_
 ...
 */
    ...
    protected:
...
#ifndef CPU_ONLY
        void forward_gpu_winograd(const Dtype *intput,const Dtype* weights, Dtype *output);
        ...
        void get_input_width(const int* out);
        void get_input_height(const int* out);
        void get_pad_width(const int* out);
        void get_pad_height(const int* out);
